...
export const GAMES = [
  ...
  },
  {
    ...
    video: 'assets/cards/little-detective.mp4',
    poster: 'assets/cards/little-detective.webp',
  },
  {
    id: 'code-a-bot',
    emoji: '🤖',
    ...
    video: 'assets/cards/code-a-bot.mp4',
    poster: 'assets/cards/code-a-bot.webp',
  },
  {
    id: 'alfa-town',
    emoji: '🏙️',
    name: 'אלפא־טאון',
    description: 'עיר שנבנית ממילים: כל שלוש מילים שפותרים מביאות לעיר גשר, אריה או חללית. ארבע שכונות, שלוש רמות גיל, 120 מילים — ובלי שום דרך להפסיד.',
    playUrl: 'games/alfa-town/index.html',
    instructionsUrl: 'games/alfa-town/instructions.html',
    playLabel: 'לבנות עיר!',
    tags: ['אוצר מילים', '120 מילים', 'גילאי 5-10'],
    progressUnit: 'מילים',
